...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Per-locale OG image URL — every page has one (generated by
  // src/app/[locale]/opengraph-image.tsx). Attaching it to each sitemap
  // entry's `images` field tells Google Image Search "this image belongs
  // to this content URL", which is the missing link for image-result
  // attribution. Without it, Google has to guess via og:image scrape.
  const ogImage = (locale: string) => `${BASE_URL}/${locale}/opengraph-image`;
